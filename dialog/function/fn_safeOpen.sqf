...
if((life_safeObj getVariable["inUse",false])) exitWith {hint "Jemand anders benutzt den Tresor"};
if({side _x == west} count playableUnits < 5) exitWith {hint "Es müssen 3 Polizisten online sein, um fortzufahren."};
