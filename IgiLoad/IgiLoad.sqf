...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Quadbike = ["I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "C_Kart_01_F", "C_Kart_01_Vrana_F", "C_Kart_01_Fuel_F", "C_Kart_01_Red_F", "C_Kart_01_Blu_F"];
	IL_Supported_ContainerBIG = ["I_UGV_01_F"];
	IL_Supported_Container = ["Land_Cargo20_blue_F", "Land_Cargo20_cyan_F", "Land_Cargo20_yellow_F", "Land_Cargo20_grey_F", "Land_Cargo20_light_blue_F", "Land_Cargo20_light_green_F", "Land_Cargo20_orange_F", "Land_Cargo20_red_F", "Land_Cargo20_sand_F", "Land_Cargo20_white_F", "Land_Cargo20_brick_red_F"];
	IL_Supported_Barrel = ["Land_PaperBox_open_full_F","Land_PaperBox_closed_F","Land_CargoBox_V1_F", "Land_BarrelEmpty_F", "Land_BarrelSand_F", "Land_BarrelTrash_F", "Land_BarrelWater_F", "Land_MetalBarrel_F"];//, "Land_MetalBarrel_empty_F", "MetalBarrel_burning_F"];
	IL_Supported_Tank = ["Land_WaterBarrel_F", "Land_WaterTank_F"];
	IL_Supported_Rubberboat = ["C_Boat_Civil_01_police_F", "C_Boat_Civil_01_rescue_F", "C_Boat_Civil_01_F", "I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat"];
	...
	IL_Supported_Cargo_MH9 = IL_Supported_Barrel;// + IL_Supported_Backpack_All;
	
	//Sattelschlepper
	IL_Supported_Cargo_SATTEL = IL_Supported_Container + IL_Supported_ContainerBIG;
	
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike;
	IL_Supported_Cargo_NonVeh_Offroad = (IL_Supported_Barrel + IL_Supported_Tank) - ["Land_WaterTank_F"];
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV;
	IL_Supported_Cargo_NonVeh_Kamaz =  IL_Supported_Barrel + IL_Supported_Tank;
	IL_Supported_Cargo_Kamaz = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_Cargo_NonVeh_Kamaz;
	
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_Hatchback;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV;
	IL_Supported_Cargo_NonVeh_Mohawk = IL_Supported_Barrel + IL_Supported_Tank;
...
if !((_obj_main_type in (IL_Supported_Vehicles_All)) || (_obj_main == Player)) exitwith
{
	if (IL_DevMod) then
	{
		Player globalChat Format["""%1"" Ist nicht verladbar", _obj_main];
	};
};
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_SATTEL) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_SATTEL, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, false];};
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_ContainerBIG) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 11.5, true];
			_obj setVariable["zload_cargo", 0.8, true];
		};
		if (_obj_type in IL_Supported_Strider) then
		{
			_obj setVariable["slots", 6, true];
			if (_obj_type in ["I_MRAP_03_F"]) then
			{
		...
		{
			_obj setVariable["slots", 6, true];
			if (_obj_type in ["B_G_Offroad_01_armed_F"]) then
			{
			...
			_obj setVariable["cargo_offset", 3.9, true];
		};
		...
		{
			_obj setVariable["zload_cargo", 0.85, true];
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Vehicles_SATTEL) && (_doors == "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		{
			{
				...
				if ((typeOf _x) == "Land_Cargo20_blue_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_cyan_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_yellow_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_grey_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_light_blue_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_light_green_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_orange_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_red_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_sand_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_white_F") then
				{
					_turn = true;
				};
				if ((typeOf _x) == "Land_Cargo20_brick_red_F") then
				{
					_turn = true;
				};
				...
				else
				{
					...
					{
						[_v, Format ["""%1"" wird im ""%2"" verladen", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_counter = (_box_num);
						...
						if ((_obj_type in IL_Supported_Vehicles_SATTEL) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-7 - _cargo_offset,_zload], [_x_cargo_offset - 0.4,_counter + 0.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
						...
						{
							[_v, Format ["""%1"" wurde im ""%2"" verstaut noch ""%3"" Kubikliter Platz.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)]] call IL_Vehicle_Chat;
						}
						else
						{
							[_v, Format ["""%1"" wurde im ""%2"" verstaut der Laderaum ist voll!", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						};
					}
					else
					{
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					{
						[_v, Format ["""%1"" wird vom ""%2"" abgeladen", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_skip = false;
						_zload = (_v getVariable "zload") + (_x getVariable "zload_cargo");
						_cargo_offset = (_v getVariable "cargo_offset") + (_x getVariable "cargo_offset");
						...
						[_v, Format ["""%1"" wurde aus dem ""%2"" geladen der Laderaum hat nun wieder ""%3"" Kubikliter Platz.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), _free_slots]] call IL_Vehicle_Chat;
						sleep 1;
					};
				};
				if (_done) exitWith {};
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Beladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug einfahren</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  eine Ladung abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Rampe Schliessen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Co-Pilot beladen zulassen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Co-Pilot beladen verbieten</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Zugriff von aussen erlauben</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Zugriff von aussen verbieten</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Absprung freigeben</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Absprung sperren</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_SATTEL) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["""%1"" Vehicle is in IL_Supported_Vehicles_SATTEL.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Container Aufsetzen</t>",
	{
		[_this select 0, IL_Supported_Cargo_SATTEL] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-9.5 - (_target getVariable 'cargo_offset'),0], IL_Supported_Cargo_SATTEL, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-9.5 - (_target getVariable 'cargo_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Ab laden</t>",
	{
		[_this select 0, false, IL_Supported_Cargo_SATTEL] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-10 - (_target getVariable 'cargo_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
	];

	_obj_main addAction [
	"<t color=""#0000ff"">Zugriff von aussen zulassen</t>",
	{
		(_this select 0) setVariable["can_outside", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Einladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Von Rechts beladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Von links endladen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Co-Pilot beladen lassen</t>",
	{
		(_this select 0) setVariable["can_copilot", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"((driver _target == _this) && !(_target getVariable 'can_copilot') && IL_Can_CoPilot)"
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Auf laden</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug auffahren und verzurren</t>",
	{
...
{
	Player globalChat Format["""%1"" wird nicht unterstützt", _obj_main_type];
};
