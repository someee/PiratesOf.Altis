...
_role1names = ["Pirates of Altis"];
_role2 = "Besuche uns auf dem Teamspeak:";
_role2names = ["ts.pirates-of-altis.de:13600"];
_role3 = "Unser Forum:";
_role3names = ["www.pirates-of-altis.de"];
...
_role6names = ["Druecke die Taste 1 fuer eine Uebersicht"];
_role7 = "Noch Fragen?";
